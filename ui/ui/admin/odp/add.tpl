...
<div class="row">
	<div class="col-sm-12 col-md-12">
	    <div class="panel panel-primary panel-hovered panel-stacked mb30">
		    <div class="panel-heading">{Lang::T('Add Optical Distribution Points')}</div>
		    <div class="panel-body">

                <form class="form-horizontal" method="post" role="form" action="{Text::url('')}odp/add-post" >
                    ...
                    <div class="form-group">
						...
						<div class="col-md-6">
							<input type="number" class="form-control" id="port_amount" name="port_amount" placeholder="8" max="16">
						</div>
                    </div>
                    <div class="form-group">
						<label class="col-md-2 control-label">{Lang::T('Attenuation')}</label>
						<div class="col-md-6">
							<input type="text" class="form-control" id="attenuation" name="attenuation" placeholder="-18.15">
						</div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
						...
						<div class="col-md-6">
							<input type="text" name="coordinates" id="coordinates" class="form-control"
                                   placeholder="6.465422, 3.406448" value="">
